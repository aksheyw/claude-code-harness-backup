...
- **`GUIDE.md` gained Part 2.5, "Using this weekly instead of once".** The guide previously offered two rungs, run this once before you wipe, or build a full backup engine, with nothing in between. Part 2.5 is the rung most people actually need: the same script, scheduled, committed to a private repo.
